...
<div id="fixed-UI-left">
  <div id="logo"><a href="<?php echo site_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/img/logo-b.png"/></a></div>
  <div id="icoo"><img src="<?php echo get_template_directory_uri(); ?>/img/icoo.png"></div>
  <div id="center-sx">
...
<div id="fixed-UI-left-mob">
  <div id="mob-logo"><a href="<?php echo site_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/img/logo-b.png"/></a></div>
  <div id="mob-icoo"><img src="<?php echo get_template_directory_uri(); ?>/img/icoo.png"></div>
</div>
