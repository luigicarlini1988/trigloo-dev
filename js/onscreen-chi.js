...
jQuery(window).scroll(function(){ // bind window scroll event
	if( jQuery('#cont-fotoservizi').length > 0 ) { // if target element exists in DOM
		if( jQuery('#cont-fotoservizi').is_on_screen() ) { // if target element is visible on screen after DOM loaded
        $('#cont-fotoservizi').addClass('in');
...
jQuery(window).scroll(function(){ // bind window scroll event
	if( jQuery('.go').length > 0 ) { // if target element exists in DOM
		if( jQuery('.go').is_on_screen() ) { // if target element is visible on screen after DOM loaded
        $('.go').addClass('in');
