...
jQuery(window).scroll(function(){ // bind window scroll event
	if( jQuery('#text-plus-form').length > 0 ) { // if target element exists in DOM
		if( jQuery('#text-plus-form').is_on_screen() ) { // if target element is visible on screen after DOM loaded
        jQuery('#text-plus-form').addClass('in');
