...
jQuery(window).scroll(function(){ // bind window scroll event
	if( jQuery('.portfolio-short-banda.uno').length > 0 ) { // if target element exists in DOM
		if( jQuery('.portfolio-short-banda.uno').is_on_screen() ) { // if target element is visible on screen after DOM loaded
        jQuery('.portfolio-short-banda.uno').addClass('in');
...
jQuery(window).scroll(function(){ // bind window scroll event
	if( jQuery('.portfolio-short-banda.due').length > 0 ) { // if target element exists in DOM
		if( jQuery('.portfolio-short-banda.due').is_on_screen() ) { // if target element is visible on screen after DOM loaded
        jQuery('.portfolio-short-banda.due').addClass('in');
...
jQuery(window).scroll(function(){ // bind window scroll event
	if( jQuery('.portfolio-short-banda.tre').length > 0 ) { // if target element exists in DOM
		if( jQuery('.portfolio-short-banda.tre').is_on_screen() ) { // if target element is visible on screen after DOM loaded
        jQuery('.portfolio-short-banda.tre').addClass('in');
