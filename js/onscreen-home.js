...
jQuery(window).scroll(function(){ // bind window scroll event
	if( jQuery('#sk1').length > 0 ) { // if target element exists in DOM
		if( jQuery('#sk1').is_on_screen() ) { // if target element is visible on screen after DOM loaded
...
jQuery(window).scroll(function(){ // bind window scroll event
	if( jQuery('#sk2').length > 0 ) { // if target element exists in DOM
		if( jQuery('#sk2').is_on_screen() ) { // if target element is visible on screen after DOM loaded
...
jQuery(window).scroll(function(){ // bind window scroll event
	if( jQuery('#sk3').length > 0 ) { // if target element exists in DOM
		if( jQuery('#sk3').is_on_screen() ) { // if target element is visible on screen after DOM loaded
